pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'almafrtk/225-lab3-4'                               //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/TibaAlMafrachi/225-lab3-4.git' //<-----change this to match this new repository!
